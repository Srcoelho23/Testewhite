...
<!-- Mirrored from http://191.232.211.37/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Mar 2021 19:07:08 GMT -->
...
<head>
    ...
    <title>Checker Full OBA | PladixOficial</title>
        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-body text-center">
              <h4 class="title mb-2">Checker de Full (Cielo Debitando)</h4>
              <textarea style="height: 8.06rem;" class="form-control text-center form-checker mb-2" placeholder="cc|mes|ano|cvv » limite de linhas 500"></textarea>
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-body">
              ...
              <h5 class="title mb-0"><i class="fa fa-user"></i> Usuario:<span class="badge badge-primary float-right user_name"><?php echo $usuario?></span></h5><hr>
              
              <h5 class="title mb-0"><i class="fa fa-wallet"></i> Saldo:<span class="badge badge-primary float-right saldo"><?php echo $saldo ?></span></h5>
...
<script>
    ...
    var iniciar = new Audio('start.mp3');
    
    var testadas = new Audio('testadas.mp3');


  $(document).ready(function() {
  
  
  Swal.fire({ title: "AVISO", text: "Olá, quer ter seu próprio checker? Ou por encomenda, contate-nos pelo @pladixoficial no Telegram!", icon: "warning", confirmButtonText: "OK", buttonsStyling: true, confirmButtonClass: 'btn btn-primary'});
...
*/
      ...
      $('.btn-matriz').attr('disabled', false);
    
    
      line.forEach(function(data) {
        var callBack = $.ajax({
          url: 'cielov3.php?lista=' + data,
